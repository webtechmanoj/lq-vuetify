...
export default Vue.extend({
    ...
    props: {
        ...
        popupWidth: {
            type: Number,
            default: () => lqVuetifyOptions.cropperPopupWidth
        },
        multiple: {
            type: Boolean,
            default: () => false
        ...
        rotateRightIcon: {
            type: String,
            default: () => lqVuetifyOptions.rotateRightIcon
        },
        rotateLeftIcon: {
            type: String,
            default: () => lqVuetifyOptions.rotateLeftIcon
        },
        deleteIcon: {
            type: String,
            default: () => lqVuetifyOptions.deleteIcon
        },
        changeIcon: {
            type: String,
            default: () => lqVuetifyOptions.changeIcon
        },
        cropIcon: {
            type: String,
            default: () => lqVuetifyOptions.cropIcon
        },
        addIcon: {
            type: String,
            default: () => lqVuetifyOptions.addIcon
        },
        viewIcon: {
            type: String,
            default: () => lqVuetifyOptions.viewIcon
        },
        deleteIconTitle: {
            type: String,
            default: () => lqVuetifyOptions.deleteIconTitle
        },
        changeIconTitle: {
            type: String,
            default: () => lqVuetifyOptions.changeIconTitle
        },
        cropIconTitle: {
            type: String,
            default: () => lqVuetifyOptions.cropIconTitle
        },
        addIconTitle: {
            type: String,
            default: () => lqVuetifyOptions.addIconTitle
        },
        viewIconTitle: {
            type: String,
            default: () => lqVuetifyOptions.viewIconTitle
        },
        formatterFnc: {
            type: Function,
            default: lqVuetifyOptions.formatterFnc
        },
        showViewBtn: {
            type: Boolean,
            default: () => false
        ...
        resetIconTitle: {
            type: String,
            default: () => lqVuetifyOptions.resetIconTitle
        },
        showResetBtn: {
            type: Boolean,
            default: () => false
        ...
        resetIcon: {
            type: String,
            default: () => lqVuetifyOptions.resetIcon
        },
        primaryKey: {
            type: String,
            default: () => lqVuetifyOptions.primaryKey
        },
        layoutTag: {
            type: String,
            default: () => 'v-row'
